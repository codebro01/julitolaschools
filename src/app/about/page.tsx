  ...
  return (
    <div className="container mx-auto px-4 py-16">
      <Card className="shadow-xl">
        <CardHeader>
          <CardTitle className="text-4xl font-headline text-primary text-center">About SchoolHub Connect</CardTitle>
        </CardHeader>
        <CardContent className="space-y-6">
          ...
          <p className="text-lg text-foreground/80 leading-relaxed">
            SchoolHub Connect is a premier international secondary school dedicated to fostering academic excellence,
          ...
          <p className="text-lg text-foreground/80 leading-relaxed">
            ...
            SchoolHub Connect offers a rich multicultural experience that broadens perspectives and encourages understanding.
          </p>
          <div className="grid md:grid-cols-2 gap-8 pt-8">
            ...
            <div>
              ...
              <p className="text-foreground/70 leading-relaxed">
                SchoolHub Connect is more than just a school; it's a vibrant community of learners, educators, and families. 
